...
def custom_preprocessing_task1(args):
    '''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default=os.path.join(base_path, 'DATASETS/Task1'),
                        help='directory where the dataset has been downloaded')
    parser.add_argument('--output_path', type=str, default=os.path.join(base_path, 'DATASETS/processed'),
