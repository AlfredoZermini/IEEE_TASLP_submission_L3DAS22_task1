...
def create_args():
    ...
    args.audio_challenge_path = os.path.join(args.audio_path, args.challenge_name, args.DNN_type, args.n_sources_string)
    ...
    args.fig_challenge_path = os.path.join(args.fig_path, args.challenge_name, args.DNN_type, args.n_sources_string)
    args.fig_challenge_masks_path = os.path.join(args.fig_challenge_path, 'masks')
